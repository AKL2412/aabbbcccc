...
<c:choose>
  ...
  <div class="row">
 	<div class="col-md-12">
 		<c:if test="${fn:length(salarie.avanceExercice(salarie.societe.exoEncours())) > 0 }">
 		
 			<div class="panel panel-default">
 			<div class="panel-heading">
 				<h3>
 				<i class="fa fa-dollar"></i>
 					Les avances de : ${salarie.etatcivile.prenom } ${salarie.etatcivile.nom } 
 					<span
 					style="float: right"
 					class="badge"
 			...
 			<table class="table table-condensed table-striped">
 				...
 				<tbody>
 					<c:forEach items="${salarie.avanceExercice(salarie.societe.exoEncours()) }" var="a">
 						<tr>
 							<td>${a.montant }</td>
 							<td>${a.mois() }</td>
 							<td>${a.motif }</td>
 	...
 	<div class="col-md-6 col-md-offset-3">
 		<div class="panel panel-default">
 			<div class="panel-heading">
 				...
 				Définir une nouvelle avance
 				</h3>
 			</div>
 			<form role="form" method="post" modelAttribute = "avance">
	 			<div class="panel-body">
